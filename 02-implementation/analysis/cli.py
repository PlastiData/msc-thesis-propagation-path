...
DEFAULT_DATA_ROOT = REPO_ROOT.parent / "04-data/telemetry/rcabench-platform-v2/data/rcabench"
OUT_ROOT = REPO_ROOT / "results/propagation_paths"
...
def run(
    *,
    ...
    out_dir = (out_root or OUT_ROOT) / sample / policy_name
...
def main(argv: list[str] | None = None) -> int:
    ...
    parser.add_argument(
        "--sample",
        type=Path,
        default=ANALYSIS_DIR / "samples" / "sample_all.txt",
